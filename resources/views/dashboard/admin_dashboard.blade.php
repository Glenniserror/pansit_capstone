...
<body>
    <div class="dashboard-container">
        <header class="navbar">
            <div class="logo-area">
                <svg class="logo-icon" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#3b82f6" stroke-width="2">
        ...
        <main class="content-wrapper">
            ...
            <div class="stats-row">
                <div class="stat-card">
                    <div class="stat-top"><span>Total Users</span> <span class="blue-icon">👥</span></div>
                    <div class="stat-val">200</div>
                    <div class="stat-label">+12 this week</div>
                </div>
                <div class="stat-card">
                    <div class="stat-top"><span>Active Students</span> <span class="green-icon">📖</span></div>
                    <div class="stat-val">107</div>
                    <div class="stat-label">54% of total</div>
                </div>
                <div class="stat-card">
                    <div class="stat-top"><span>Teachers</span> <span class="orange-icon">👥</span></div>
                    <div class="stat-val">23</div>
                    <div class="stat-label">All active</div>
                </div>
                <div class="stat-card">
                    <div class="stat-top"><span>System Health</span> <span class="blue-light-icon">📈</span></div>
            ...
            <div class="modules-grid">
                <div class="module-card">
                    ...
                    <button class="blue-action">Manage Users</button>
                </div>
                <div class="module-card">
                    <div class="banner-strip green-strip">🛡️</div>
                    <h3>Roles & Permissions</h3>
                    <p>Configure acess levels and privileges</p>
                    <button class="blue-action">Configure Roles</button>
                </div>
                <div class="module-card">
                    <div class="banner-strip orange-strip">📊</div>
                    <h3>Analytics</h3>
                    <p>View platform usage and perform metrics</p>
                    <button class="blue-action">View Analytics</button>
                </div>
                <div class="module-card">
                    <div class="banner-strip blue-strip">📈</div>
                    <h3>Activity Tracking</h3>
                    <p>Monitor active users and engagement</p>
                    <button class="blue-action">Track Activity</button>
                </div>
                <div class="module-card">
                    <div class="banner-strip green-strip">📖</div>
                    <h3>Content Management</h3>
                    <p>Manage learning modules and materials</p>
                    <button class="blue-action">Manage Content</button>
                </div>
                <div class="module-card">
                    <div class="banner-strip orange-strip">⚙️</div>
                    <h3>System Settings</h3>
                    <p>Configure platform preferences and features</p>
                    <button class="blue-action">Send Feedback</button>
                </div>
            </div>
